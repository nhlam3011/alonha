...
export type ListingStatus = "PENDING" | "APPROVED" | "REJECTED" | "EXPIRED" | "HIDDEN";
...
export function ListingsAdminClient({ initialListings }: { initialListings: ListingRow[] }) {
    ...
    const [status, setStatus] = useState<"ALL" | ListingStatus>(initialStatus);
    ...
    }, [keyword, status, pathname, router, initialKeyword, initialStatus]);
