...
async function main() {
  ...
  const listings = [
    ...
    // 36. Cần Thơ – căn hộ cao cấp
    {
      provinceName: "Thành phố Cần Thơ",
      provinceKeyword: "Cần Thơ",
      title: "Căn hộ 2PN Vinhomes Cần Thơ, view sông Hậu",
      listingType: "SALE" as const,
      category: "CAN_HO_CHUNG_CU" as const,
      price: 2_800_000_000,
      pricePerSqm: 45_000_000,
      area: 62,
      bedrooms: 2,
      bathrooms: 2,
      direction: "Đông",
      ...
      address: "Đường Nguyễn Văn Cừ, Phường An Bình, Quận Ninh Kiều, TP. Cần Thơ",
      wardName: "Phường An Bình",
      latitude: 10.0321,
      longitude: 105.7792,
      description:
        "Căn hộ 2PN tại Vinhomes Cần Thơ, tầng cao view sông Hậu. Nội thất cao cấp, tiện ích đầy đủ.",
      isVip: true,
      isVerified: true,
      images: [
        "https://images.unsplash.com/photo-1502672023488-70e25813eb80?auto=format&fit=crop&w=1200&q=80",
    ...
    // 37. Cần Thơ – nhà phố cho thuê
    {
      provinceName: "Thành phố Cần Thơ",
      provinceKeyword: "Cần Thơ",
      title: "Cho thuê nhà phố 3 tầng Ninh Kiều",
      listingType: "RENT" as const,
      category: "NHA_MAT_PHONG" as const,
      price: 15_000_000,
      area: 150,
      ...
      legalStatus: "Hợp đồng 12 tháng",
      furniture: "Full nội thất",
      address: "Đường 30/4, Phường Xuân Khánh, Quận Ninh Kiều, TP. Cần Thơ",
      wardName: "Phường Xuân Khánh",
      latitude: 10.0225,
      longitude: 105.7852,
      description:
        "Nhà phố 3 tầng mặt tiền đường 30/4, gần trung tâm. Phù hợp kinh doanh hoặc cho thuê.",
      isVerified: true,
      images: [
        "https://images.unsplash.com/photo-1568605114967-8130f3a36994?auto=format&fit=crop&w=1200&q=80",
        "https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&w=1200&q=80",
    ...
    // 38. Hải Phòng – căn hộ cao cấp
    {
      provinceName: "Thành phố Hải Phòng",
      provinceKeyword: "Hải Phòng",
      title: "Căn hộ 2PN Vinhomes Hải Phòng, view cảng",
      listingType: "SALE" as const,
      category: "CAN_HO_CHUNG_CU" as const,
      price: 3_200_000_000,
      pricePerSqm: 42_000_000,
      area: 76,
      bedrooms: 2,
      bathrooms: 2,
      direction: "Đông Bắc",
      legalStatus: "Sổ hồng lâu dài",
      furniture: "Full nội thất cao cấp",
      address: "Đường Lê Hồng Phong, Phường Đằng Hải, Quận Hải An, TP. Hải Phòng",
      wardName: "Phường Đằng Hải",
      latitude: 20.8456,
      longitude: 106.6934,
      description:
        "Căn hộ 2PN tại Vinhomes Hải Phòng, tầng cao view cảng biển. Tiện ích hiện đại.",
      isVip: true,
      isVerified: true,
      images: [
        "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=1200&q=80",
    ...
    // 39. Hải Phòng – nhà phố cho thuê
    {
      provinceName: "Thành phố Hải Phòng",
      provinceKeyword: "Hải Phòng",
      title: "Cho thuê nhà phố 4 tầng Quận Lê Chân",
      listingType: "RENT" as const,
      category: "NHA_MAT_PHONG" as const,
      price: 18_000_000,
      area: 140,
      ...
      legalStatus: "Hợp đồng 12 tháng",
      furniture: "Nội thất cơ bản",
      address: "Đường Tô Hiệu, Phường Hồ Nam, Quận Lê Chân, TP. Hải Phòng",
      wardName: "Phường Hồ Nam",
      latitude: 20.8523,
      longitude: 106.6921,
      description:
        "Nhà phố 4 tầng mặt tiền, gần trung tâm thành phố. Phù hợp kinh doanh hoặc cho thuê.",
      isVerified: true,
      images: [
        "https://images.unsplash.com/photo-1502672023488-70e25813eb80?auto=format&fit=crop&w=1200&q=80",
        "https://images.unsplash.com/photo-1568605114967-8130f3a36994?auto=format&fit=crop&w=1200&q=80",
    ...
    // 40. Bình Dương – căn hộ cho thuê
    {
      provinceName: "Tỉnh Bình Dương",
      provinceKeyword: "Bình Dương",
      title: "Cho thuê căn hộ 1PN Thuận An",
      listingType: "RENT" as const,
      category: "CAN_HO_CHUNG_CU" as const,
      price: 6_000_000,
      area: 45,
      ...
      legalStatus: "Hợp đồng 12 tháng",
      furniture: "Full nội thất",
      address: "Đường DT743, Phường Hoà Phú, TP. Thuận An, Tỉnh Bình Dương",
      wardName: "Phường Hoà Phú",
      latitude: 10.9512,
      longitude: 106.7123,
      description:
        "Căn hộ 1PN tại TP. Thuận An, gần KCN. Full nội thất, phù hợp công nhân viên.",
      isVerified: true,
      images: [
        "https://images.unsplash.com/photo-1521782462922-9318be1a5a22?auto=format&fit=crop&w=1200&q=80",
        "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=1200&q=80",
    ...
    // 41. Bình Dương – đất nền
    {
      provinceName: "Tỉnh Bình Dương",
      provinceKeyword: "Bình Dương",
      title: "Đất nền 150m² Dĩ An, sổ riêng",
      listingType: "SALE" as const,
      category: "DAT_NEN" as const,
      price: 3_500_000_000,
      area: 150,
      ...
      furniture: null,
      address: "Phường An Bình, TP. Dĩ An, Tỉnh Bình Dương",
      wardName: "Phường An Bình",
      latitude: 10.9189,
      longitude: 106.8456,
      description:
        "Đất nền 150m², sổ đỏ riêng, đường bê tông. Gần KCN và trung tâm TP.HCM.",
      isVerified: true,
      images: [
        "https://images.unsplash.com/photo-1517061493161-3d9b2e4a52c5?auto=format&fit=crop&w=1200&q=80",
        "https://images.unsplash.com/photo-1501117716987-c8e1ecb2108a?auto=format&fit=crop&w=1200&q=80",
    ...
    // 42. Long An – đất nền
    {
      ...
      provinceKeyword: "Long An",
      title: "Đất nền 200m² Đức Hòa, gần cửa ngõ TP.HCM",
      listingType: "SALE" as const,
      category: "DAT_NEN" as const,
      price: 2_200_000_000,
      area: 200,
      ...
      legalStatus: "Sổ đỏ riêng",
      furniture: null,
      address: "Huyện Đức Hòa, Tỉnh Long An",
      wardName: "Thị trấn Đức Hòa",
      latitude: 10.8567,
      longitude: 106.4567,
      description:
        "Đất nền 200m² tại Đức Hòa, vị trí chiến lược cửa ngõ TP.HCM. Tiềm năng tăng giá cao.",
      isVip: true,
      isVerified: true,
      images: [
        "https://images.unsplash.com/photo-1500534314211-0a24cd03f2c0?auto=format&fit=crop&w=1200&q=80",
    ...
    // 43. Long An – nhà phố cho thuê
    {
      provinceName: "Tỉnh Long An",
      provinceKeyword: "Long An",
      title: "Cho thuê nhà phố 2 tầng Tân An",
      listingType: "RENT" as const,
      category: "NHA_RIENG" as const,
      price: 10_000_000,
      area: 100,
      ...
      legalStatus: "Hợp đồng 12 tháng",
      furniture: "Nội thất cơ bản",
      address: "Phường 2, TP. Tân An, Tỉnh Long An",
      wardName: "Phường 2",
      latitude: 10.5356,
      longitude: 106.4101,
      description:
        "Nhà phố 2 tầng tại TP. Tân An, gần chợ và trung tâm. Phù hợp ở hoặc cho thuê.",
      isVerified: true,
      images: [
        "https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=1200&q=80",
        "https://images.unsplash.com/photo-1568605114967-8130f3a36994?auto=format&fit=crop&w=1200&q=80",
    ...
    // 44. Vũng Tàu – biệt thự nghỉ dưỡng
    {
      provinceName: "Tỉnh Bà Rịa - Vũng Tàu",
      provinceKeyword: "Vũng Tàu",
      title: "Biệt thự 4PN gần bãi biển Vũng Tàu",
      listingType: "SALE" as const,
      category: "NHA_RIENG" as const,
      price: 12_500_000_000,
      pricePerSqm: 85_000_000,
      area: 147,
      bedrooms: 4,
      bathrooms: 4,
      direction: "Nam",
      ...
      furniture: "Full nội thất cao cấp",
      address: "Đường Phạm Ngọc Thạch, Phường Thắng Tam, TP. Vũng Tàu, Tỉnh Bà Rịa - Vũng Tàu",
      wardName: "Phường Thắng Tam",
      latitude: 10.3532,
      longitude: 107.0845,
      description:
        "Biệt thự 4PN gần bãi biển, view biển đẹp. Full nội thất, phù hợp nghỉ dưỡng hoặc đầu tư.",
      isVip: true,
      isVerified: true,
      images: [
    ...
    // 45. Vũng Tàu – căn hộ cho thuê
    {
      provinceName: "Tỉnh Bà Rịa - Vũng Tàu",
      provinceKeyword: "Vũng Tàu",
      title: "Cho thuê căn hộ 2PN view biển Vũng Tàu",
      listingType: "RENT" as const,
      category: "CAN_HO_CHUNG_CU" as const,
      price: 12_000_000,
      area: 70,
      ...
      legalStatus: "Hợp đồng 12 tháng",
      furniture: "Full nội thất",
      address: "Đường Thùy Vân, Phường 2, TP. Vũng Tàu, Tỉnh Bà Rịa - Vũng Tàu",
      wardName: "Phường 2",
      latitude: 10.3478,
      longitude: 107.0823,
      description:
        "Căn hộ 2PN view biển, cách bãi tắm Vũng Tàu vài bước chân. Full nội thất, tiện ích đầy đủ.",
      isVip: true,
      isVerified: true,
      images: [
        "https://images.unsplash.com/photo-1505691723518-36a5ac3be353?auto=format&fit=crop&w=1200&q=80",
    ...
    // 46. TP.HCM – căn hộ TP. Thủ Đức
    {
      provinceName: "Thành phố Hồ Chí Minh",
      provinceKeyword: "Hồ Chí Minh",
      title: "Căn hộ 3PN The Celesta TP. Thủ Đức",
      listingType: "SALE" as const,
      category: "CAN_HO_CHUNG_CU" as const,
      price: 4_200_000_000,
      pricePerSqm: 55_000_000,
      area: 76,
      bedrooms: 3,
      bathrooms: 2,
      direction: "Đông",
      legalStatus: "Sổ hồng lâu dài",
      furniture: "Full nội thất cao cấp",
      address: "Đường Nguyễn Hoàng, Phường An Phú, TP. Thủ Đức, TP. Hồ Chí Minh",
      wardName: "Phường An Phú",
      latitude: 10.7956,
      longitude: 106.7278,
      description:
        "Căn hộ 3PN tại The Celesta, TP. Thủ Đức. Gần Metro, tiện ích đầy đủ, thiết kế hiện đại.",
      isVip: true,
      isVerified: true,
      hasVideo: true,
      images: [
    ...
    // 47. TP.HCM – biệt thự Quận 7
    {
      provinceName: "Thành phố Hồ Chí Minh",
      provinceKeyword: "Hồ Chí Minh",
      title: "Biệt thự song lập 5PN Quận 7, gần Phú Mỹ Hưng",
      listingType: "SALE" as const,
      category: "NHA_RIENG" as const,
      price: 28_000_000_000,
      pricePerSqm: 140_000_000,
      area: 200,
      bedrooms: 5,
      bathrooms: 5,
      direction: "Nam",
      ...
      longitude: 106.7156,
      description:
        "Biệt thự song lập 5PN tại khu cao cấp Quận 7, gần Phú Mỹ Hưng. Thiết kế sang trọng.",
      isVip: true,
      isVerified: true,
      hasVideo: true,
      has360Tour: true,
    ...
    // 48. Hà Nội – căn hộ Times City
    {
      provinceName: "Thành phố Hà Nội",
      provinceKeyword: "Hà Nội",
      title: "Căn hộ 2PN Times City, view hồ Thanh Nhàn",
      listingType: "SALE" as const,
      category: "CAN_HO_CHUNG_CU" as const,
      price: 5_800_000_000,
      pricePerSqm: 83_000_000,
      area: 70,
      bedrooms: 2,
      bathrooms: 1,
      direction: "Tây",
      legalStatus: "Sổ đỏ lâu dài",
      furniture: "Full nội thất cao cấp",
      address: "Đường Minh Khai, Phường Thanh Nhàn, Quận Hai Bà Trưng, TP. Hà Nội",
      wardName: "Phường Thanh Nhàn",
      latitude: 20.9987,
      longitude: 105.8567,
      description:
        "Căn hộ 2PN tại Times City, tầng cao view hồ. Nội thất cao cấp, tiện ích 5*.",
      isVip: true,
      isVerified: true,
      hasVideo: true,
      images: [
  ...
  const projects = [
    // TP. Hồ Chí Minh (sau sáp nhập gồm TP. Thủ Đức)
    {
    ...
    },
    {
      ...
      address: "Nguyễn Xiển, Phường Long Thạnh Mỹ, TP. Thủ Đức, TP. Hồ Chí Minh",
      developer: "Vingroup",
      totalArea: 271,
    ...
    },
    {
      ...
      address: "Hương Lộ 2, Phường Long Hưng, TP. Biên Hòa, Tỉnh Đồng Nai",
      developer: "Novaland",
      totalArea: 1000,
    ...
    {
      name: "Celesta Rise",
      description: "Khu căn hộ cao cấp với thiết kế xanh hiện đại, tiện ích đầy đủ, vị trí chiến lược tại TP. Thủ Đức.",
      address: "Nguyễn Hoàng, Phường An Phú, TP. Thủ Đức, TP. Hồ Chí Minh",
      developer: "Phú Long",
      totalArea: 3.5,
      imageUrl: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1200&q=80",
    },
    {
      name: "Vinhomes Sports City",
      description: "Đại đô thị thể thao tại TP. Thủ Đức với sân vận động hiện đại, công viên và hồ điều hòa.",
      address: "Đại lộ Võ Chí Công, Phường Long Thạnh Mỹ, TP. Thủ Đức, TP. Hồ Chí Minh",
      developer: "Vingroup",
      totalArea: 64,
    ...
    },
    {
      ...
      description: "Khu căn hộ cao cấp kết nối trung tâm TP.HCM và các tỉnh lân cận, tiện ích hiện đại.",
      address: "Quốc lộ 1A, Phường An Bình, TP. Dĩ An, Tỉnh Bình Dương",
      developer: "Phú Đông Group",
      totalArea: 5.2,
      imageUrl: "https://images.unsplash.com/photo-1600585154340-0ef3c08c0632?w=1200&q=80",
    },
    // Hà Nội
    {
      name: "Vinhomes Ocean Park",
      description: "Thành phố biển hồ giữa lòng Hà Nội. Nổi bật với biển hồ nước mặn 6.1ha và hồ Ngọc Trai 24.5ha.",
      address: "Xã Đa Tốn, Huyện Gia Lâm, TP. Hà Nội",
      developer: "Vingroup",
      totalArea: 420,
    ...
    },
    {
      ...
      developer: "Vingroup",
      totalArea: 280,
      imageUrl: "https://images.unsplash.com/photo-1574362848149-11496d93e93d?w=1200&q=80",
    },
    {
      name: "Ecopark",
      description: "Thành phố xanh lớn nhất miền Bắc, sở hữu hệ sinh thái thiên nhiên đẳng cấp với hơn 1 triệu cây xanh.",
      address: "Xã Xuân Quan, Huyện Văn Giang, Tỉnh Hưng Yên",
      developer: "Ecopark",
      totalArea: 500,
      imageUrl: "https://images.unsplash.com/photo-1628624747186-a941c476b7ef?w=1200&q=80",
    },
    {
      name: "The Leader An Phú",
      description: "Tổ hợp căn hộ và trung tâm thương mại tại khu vực cửa ngõ phía Tây Hà Nội, giao thông thuận tiện.",
      address: "Đường Lê Trọng Tấn, Phường Dương Nội, Quận Hà Đông, TP. Hà Nội",
      developer: "The Leader Group",
      totalArea: 2.8,
      imageUrl: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=1200&q=80",
    },
    {
      name: "Gamuda Gardens",
      description: "Khu đô thị sinh thái xanh với công viên cây xanh rộng lớn, hồ điều hòa và tiện ích hiện đại.",
      address: "Đường Gamuda, Phường Trần Phú, Quận Hoàng Mai, TP. Hà Nội",
    ...
    {
      name: "Monarchy City",
      description: "Khu phức hợp cao cấp tại trung tâm Đà Nẵng, view sông Hàn và cầu Rồng.",
      address: "Đường Bạch Đằng, Phường Hải Châu 1, Quận Hải Châu, TP. Đà Nẵng",
      developer: "Vingroup",
      totalArea: 4.5,
      imageUrl: "https://images.unsplash.com/photo-1555468275-8a69d4274b0d?w=1200&q=80",
    },
    {
      name: "Cocobay Danang",
      description: "Khu căn hộ và biệt thự du lịch tại bãi biển Mỹ Khê, tiện ích nghỉ dưỡng đẳng cấp.",
      address: "Đường Võ Nguyên Giáp, Phường Khuê Mỹ, Quận Ngũ Hành Sơn, TP. Đà Nẵng",
    ...
    // Cần Thơ
    {
      name: "Vinhomes Cần Thơ",
      description: "Khu đô thị cao cấp tại miền Tây, sở hữu vị trí đắc địa bên sông Hậu.",
      address: "Đường Nguyễn Văn Cừ, Phường An Bình, Quận Ninh Kiều, TP. Cần Thơ",
      developer: "Vingroup",
      totalArea: 85,
      imageUrl: "https://images.unsplash.com/photo-1594488518063-54917409546d?w=1200&q=80",
    ...
    // Hải Phòng
    {
      name: "Vinhomes Hải Phòng",
      description: "Khu đô thị sinh thái ven biển tại Hải Phòng, tầm nhìn ra cảng biển.",
      address: "Đường Lê Hồng Phong, Phường Đằng Hải, Quận Hải An, TP. Hải Phòng",
      developer: "Vingroup",
      totalArea: 120,
      imageUrl: "https://images.unsplash.com/photo-1580587771525-78b9dba3b91d?w=1200&q=80",
    },
    {
      ...
      description: "Khu trung tâm thương mại và căn hộ cao cấp tại vị trí trung tâm thành phố.",
      address: "Đường Tô Hiệu, Phường Hồ Nam, Quận Lê Chân, TP. Hải Phòng",
    ...
    // Nha Trang - Khánh Hòa
    {
      name: "Vegas Nha Trang",
      description: "Khu căn hộ và biệt thự nghỉ dưỡng cao cấp tại bãi biển Tràng An, view biển đẹp.",
      address: "Đường Trần Phú, Phường Lộc Thọ, TP. Nha Trang, Tỉnh Khánh Hòa",
      developer: "Rico Group",
      totalArea: 8.5,
      imageUrl: "https://images.unsplash.com/photo-1574362848149-11496d93e7c7?w=1200&q=80",
    },
    {
      name: "Movenpick Cam Ranh",
      description: "Khu nghỉ dưỡng cao cấp tại vịnh Cam Ranh, bãi biển riêng đẳng cấp.",
      address: "Bãi Dài, Phường Cam Nghĩa, TP. Cam Ranh, Tỉnh Khánh Hòa",
      developer: "Movenpick",
      totalArea: 35,
      imageUrl: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=1200&q=80",
    },
    ...
    {
      name: "Grand Marina Club",
      description: "Khu căn hộ và biệt thự cao cấp tại bờ biển Vũng Tàu, tầm nhìn ra hướng biển Đông.",
      address: "Đường Phạm Ngọc Thạch, Phường Thắng Tam, TP. Vũng Tàu, Tỉnh Bà Rịa - Vũng Tàu",
      developer: "CEO Group",
      totalArea: 15,
      imageUrl: "https://images.unsplash.com/photo-1449844908441-8829872d2607?w=1200&q=80",
    ...
    // Bình Dương
    {
      name: "Phú Mỹ Hưng Bình Dương",
      description: "Khu đô thị sinh thái tại Bình Dương, môi trường sống xanh mát.",
      address: "Đường ĐT743, Phường Hoà Phú, TP. Thuận An, Tỉnh Bình Dương",
    ...
    // Đồng Nai
    {
      name: "Long Thanh Golf",
      description: "Khu đô thị và sân golf cao cấp tại Long Thành, tiềm năng phát triển lớn.",
      address: "Xã Long An, Huyện Long Thành, Tỉnh Đồng Nai",
      developer: "Long Thanh Golf",
      totalArea: 300,
      imageUrl: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1200&q=80",
    },
    // Long An
    {
      name: "Đức Hòa Hưng",
      description: "Khu đô thị sinh thái với vị trí chiến lược tại cửa ngõ TP.HCM.",
      address: "Huyện Đức Hòa, Tỉnh Long An",
      developer: "Đức Hòa Hưng",
      totalArea: 450,
      imageUrl: "https://images.unsplash.com/photo-1600585154340-0ef3c08c0632?w=1200&q=80",
    },
    // Quảng Ninh
    {
      name: "Ha Long Xanh",
      description: "Khu đô thị sinh thái cao cấp tại vịnh Hạ Long, tầm nhìn ra di sản thiên nhiên thế giới.",
      address: "Đường Ba Đình, Phường Hồng Hải, TP. Hạ Long, Tỉnh Quảng Ninh",
      developer: "Vingroup",
      totalArea: 120,
      imageUrl: "https://images.unsplash.com/photo-1574362848149-11496d93e93d?w=1200&q=80",
    },
